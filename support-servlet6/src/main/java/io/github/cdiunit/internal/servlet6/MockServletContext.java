...
public class MockServletContext implements ServletContext {
    ...
    private static final Set<SessionTrackingMode> DEFAULT_SESSION_TRACKING_MODES = Set.of(
            SessionTrackingMode.COOKIE, SessionTrackingMode.URL, SessionTrackingMode.SSL);
