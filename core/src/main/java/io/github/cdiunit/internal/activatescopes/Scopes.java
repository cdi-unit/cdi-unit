...
public class Scopes {
    ...
    public Scopes(Collection<Class<? extends Annotation>> scopeTypes) {
        this.scopeTypes = Set.copyOf(scopeTypes);
    }

    static Scopes of(Collection<Class<? extends Annotation>> scopeTypes) {
        return new Scopes(scopeTypes);
    }
